...
class Canvas(app.Canvas):
    def __init__(self):
        ...
        app.Canvas.__init__(self, title='Framebuffer post-processing',
                            keys='interactive', size=im.shape[:2])
        ...
        im = misc.imread('/root/PycharmProjects/equations/cm/processed/Edge.png')
        color = Texture2D(im, interpolation='linear')
        self.framebuffer = FrameBuffer(color, RenderBuffer(im.shape[:2]))
